...
from .views import NoteListCreateView, NoteDetailView, generate_summary, generate_quiz_view, share_note, improve_note_view
...
urlpatterns = [
    ...
    path('<int:note_id>/improve/', improve_note_view, name='improve-note'),
